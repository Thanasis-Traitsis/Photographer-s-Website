...
function contentAnimation() {
  ...
  if(window.location.pathname == '/index.html' || window.location.pathname === "https://marioskgm.netlify.app/") {
  ...
  if(window.location.pathname == '/services.html'){
    ...
    if(window.innerWidth < 1200){
      welcomeServices.fromTo(servicesImages1, {x: "100%"}, {x: "0", delay: 2});
      welcomeServices.fromTo(servicesImages2, {x: "100%"}, {x: "0"}, "<35%");
    }

    else{
      welcomeServices.fromTo(servicesImages2, {x: "-300%"}, {x: "0", delay: 2});
